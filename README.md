...
```javascript
import iterSignum from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-signum@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-iter-special-signum/tags). For example,

```javascript
import iterSignum from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-signum@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-signum/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/math-iter-special-signum/actions/workflows/test.yml?query=branch:v0.2.0
...
[deno-readme]: https://github.com/stdlib-js/math-iter-special-signum/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/math-iter-special-signum/tree/umd
[umd-readme]: https://github.com/stdlib-js/math-iter-special-signum/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/math-iter-special-signum/tree/esm
[esm-readme]: https://github.com/stdlib-js/math-iter-special-signum/blob/esm/README.md
